# Vendored from https://github.com/microsoft/qlib/blob/main/scripts/dump_bin.py (MIT License, Copyright (c) Microsoft Corporation).
# Fetched 2026-09-21. Converts per-symbol CSV files into Qlib binary format. Unmodified.
